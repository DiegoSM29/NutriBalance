...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Tu pedido <strong>#{{ $pedido->id_pedido }}</strong> ha sido entregado con éxito.</p>

            <div class="info">
                <p><strong>Número de pedido:</strong> #{{ $pedido->id_pedido }}</p>
                <p><strong>Estado:</strong> <span class="badge">Entregado</span></p>
            ...
            <p>Esperamos que disfrutes tu compra. ¡Gracias por preferirnos!</p>
        </div>
        <div class="footer">
